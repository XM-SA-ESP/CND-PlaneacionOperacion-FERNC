...
class TestCalculoEolica(unittest.TestCase):
    ...
    @mock.patch("dominio.servicio.eolica.servicio_eolicas.ServicioEolicas.ejecutar_calculos")
    ...
    @mock.patch("dominio.servicio.eolica.servicio_eolicas.ServicioEolicas.ejecutar_calculos")
    @mock.patch("infraestructura.calculos.eolica.calculo_eolica.enviar_excepcion_sb_transversal")
