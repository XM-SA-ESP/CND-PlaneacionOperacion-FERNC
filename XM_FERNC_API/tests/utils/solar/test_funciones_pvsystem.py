...
class TestPVSystem(unittest.TestCase):
    def test_crear_montura_con_seguidores(self):
        ...
        self.assertIsInstance(result, pvlib.pvsystem.SingleAxisTrackerMount)
    ...
    def test_crear_montura_no_seguidores(self):
        ...
        self.assertIsInstance(result, pvlib.pvsystem.FixedMount)
    ...
    def test_crear_array(self):
        ...
        self.assertIsInstance(result, pvlib.pvsystem.Array)
