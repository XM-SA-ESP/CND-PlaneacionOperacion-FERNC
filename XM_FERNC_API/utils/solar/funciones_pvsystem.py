...
def crear_montura_con_seguidores(params_array):
    ...
    y replicar el método SingleAxisTrackerMount de la librería pvlib en un paquete privado de Python
    ...
    """
    montura = pvlib.pvsystem.SingleAxisTrackerMount(
...
def crear_montura_no_seguidores(params_array):
    ...
    """
    montura = pvlib.pvsystem.FixedMount(
