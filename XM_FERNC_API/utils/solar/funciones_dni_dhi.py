...
class CalculoDniDhi:
    ...
    def obtener_irradiacion_extraterrestre(
        ...
        iext = pvlib.irradiance.get_extra_radiation(
    ...
    def obtener_dni(self, df: Pandas_Dataframe) -> Pandas_Dataframe:
        ...
        """
        serie_dni = pvlib.irradiance.disc(
            ghi=df.GHI,
    ...
    def obtener_dhi(
        ...
        serie_dni["ghi [Wh/m2]"] = calculo_df["GHI"]
        ...
        local_df = local_df.with_columns(
            [
                pl.struct(["ghi [Wh/m2]", "dni", "zenith"])
        ...
        serie_dni = serie_dni[["dni", "dhi", "kt", "zenith", "ghi [Wh/m2]", "airmass"]]
