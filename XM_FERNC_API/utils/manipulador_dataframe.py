...
class ManipuladorDataframe:
    ...
    def calcular_eda(self, params_trans: ParametrosTransversalesSolar, df_em: pd.DataFrame, enficc: Resultado) -> List[Resultado]:
        """
    ...
    def transform_eda(self, eda: list[Resultado]) -> pd.DataFrame:
        ...
        df_eda['EDA [kWh/día]'] = df_eda['EDA [kWh/día]'].fillna("N/A")
        return df_eda
