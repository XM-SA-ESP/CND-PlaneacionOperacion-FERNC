...
class MensajesEolica():
    ...
    class Error(Enum):
        ...
        H_PRIMA = "Error en el calculo de la altura de la capa limite. Verifique los parametros de los aerogeneradores."
        RADIO_ESTELA = "Error en el calculo de la estela. Verifique los parametros de los aerogeneradores."
        SPLINE_CUBICO = "Error en la interpolacion del coeficiente de empuje. Verifique los aprametros correspondientes a las curvas del fabricante."
        DISTANCIA_ESTELA_ROTOR = "Error en el calculo de la distancia de la estela del aerogenerador. Verifique los parametros de los aerogeneradores."
